...
type Geometry struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Coordinates   []*Cordinate           `protobuf:"bytes,1,rep,name=coordinates,proto3" json:"coordinates,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Geometry) GetCoordinates() []*Cordinate {
	if x != nil {
...
const file_trip_proto_rawDesc = "" +
	...
	"\vEndLocation\x18\x03 \x01(\v2\x0f.trip.CordinateR\vEndLocation\"~\n" +
	...
	"\bGeometry\x121\n" +
	"\vcoordinates\x18\x01 \x03(\v2\x0f.trip.CordinateR\vcoordinates\"\x82\x01\n" +
	"\bRideFare\x12\x0e\n" +
...
var file_trip_proto_goTypes = []any{
	...
	(*Cordinate)(nil),           // 2: trip.Cordinate
...
var file_trip_proto_depIdxs = []int32{
	2,  // 0: trip.PreviewTripRequest.StartLocation:type_name -> trip.Cordinate
	2,  // 1: trip.PreviewTripRequest.EndLocation:type_name -> trip.Cordinate
	...
	2,  // 5: trip.Geometry.coordinates:type_name -> trip.Cordinate
